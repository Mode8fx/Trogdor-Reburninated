...
void InitializeSFX() {
	...
	sfx_sb4.path = getPreferredSfxPath("voice/trog_sb4");
	sfx_sb5.path = getPreferredSfxPath("voice/trog_sb5");
	sfx_sb6.path = getPreferredSfxPath("voice/trog_sb6");
	sfx_sb7.path = getPreferredSfxPath("voice/trog_sb7");
	sfx_sbarch.path = getPreferredSfxPath("voice/trog_sbarch");
	sfx_sbarchend.path = getPreferredSfxPath("voice/trog_sbarchend");
	sfx_sbbest.path = getPreferredSfxPath("voice/trog_sbbest");
	sfx_sbdooj.path = getPreferredSfxPath("voice/trog_sbdooj");
	sfx_sbgameover.path = getPreferredSfxPath("voice/trog_sbgameover");
	sfx_sbkerrek.path = getPreferredSfxPath("voice/trog_sbkerrek");
	sfx_sblevelbeat.path = getPreferredSfxPath("voice/trog_sblevelbeat");
	sfx_sbscore.path = getPreferredSfxPath("voice/trog_sbscore");
	sfx_sbsecret.path = getPreferredSfxPath("voice/trog_sbsecret");
	sfx_sbsquish1.path = getPreferredSfxPath("voice/trog_sbsquish1");
	sfx_sbsquish2.path = getPreferredSfxPath("voice/trog_sbsquish2");
	sfx_sbwin.path = getPreferredSfxPath("voice/trog_sbwin");
	sfx_sbwin2.path = getPreferredSfxPath("voice/trog_sbwin2");
	sfx_sbworst.path = getPreferredSfxPath("voice/trog_sbworst");
	...
	makeSoundStatic(sfxArr_strongBad[6]);
	sfxArr_strongBad[7] = &sfx_sbarch;
	makeSoundStatic(sfxArr_strongBad[7]);
	sfxArr_strongBad[8] = &sfx_sbarchend;
	sfxArr_strongBad[9] = &sfx_sbbest;
	makeSoundStatic(sfxArr_strongBad[9]);
	sfxArr_strongBad[10] = &sfx_sbdooj;
	makeSoundStatic(sfxArr_strongBad[10]);
...
void HandleErrorText(const char *badPath) {
	...
	quickErrorTextRender_2("[Trogdor: Reburninated v2.4]", 0.9);
	TTF_CloseFont(font_commodore_error_1.font);
	TTF_CloseFont(font_commodore_error_2.font);
