...
void InitializeSpritesPart1() {
	...
	PREPARE_SPRITE(sprite_overlay_basement_top, basement_top_240p_bmp, basement_top_240p_bmp_len, 0, 0, 1, 1, 1);
	sprite_overlay_basement_top_ins = SpriteInstance(&sprite_overlay_basement_top, 0, 0);
	PREPARE_SPRITE(sprite_overlay_basement_bottom, basement_bottom_240p_bmp, basement_bottom_240p_bmp_len, 0, 210, 1, 1, 1);
	sprite_overlay_basement_bottom_ins = SpriteInstance(&sprite_overlay_basement_bottom, 0, 0);
	PREPARE_SPRITE(sprite_overlay_basement_left, basement_left_240p_bmp, basement_left_240p_bmp_len, 0, 30, 1, 1, 1);
	sprite_overlay_basement_left_ins = SpriteInstance(&sprite_overlay_basement_left, 0, 0);
	PREPARE_SPRITE(sprite_overlay_basement_right, basement_right_240p_bmp, basement_right_240p_bmp_len, 285, 30, 1, 1, 1);
	sprite_overlay_basement_right_ins = SpriteInstance(&sprite_overlay_basement_right, 0, 0);
	PREPARE_SPRITE(sprite_overlay_compy_top, compy_top_240p_bmp, compy_top_240p_bmp_len, 0, 0, 1, 1, 1);
	sprite_overlay_compy_top_ins = SpriteInstance(&sprite_overlay_compy_top, 0, 0);
	PREPARE_SPRITE(sprite_overlay_compy_bottom, compy_bottom_240p_bmp, compy_bottom_240p_bmp_len, 0, 210, 1, 1, 1);
	sprite_overlay_compy_bottom_ins = SpriteInstance(&sprite_overlay_compy_bottom, 0, 0);
	PREPARE_SPRITE(sprite_overlay_compy_left, compy_left_240p_bmp, compy_left_240p_bmp_len, 0, 30, 1, 1, 1);
	sprite_overlay_compy_left_ins = SpriteInstance(&sprite_overlay_compy_left, 0, 0);
	PREPARE_SPRITE(sprite_overlay_compy_right, compy_right_240p_bmp, compy_right_240p_bmp_len, 285, 30, 1, 1, 1);
	sprite_overlay_compy_right_ins = SpriteInstance(&sprite_overlay_compy_right, 0, 0);
	PREPARE_SPRITE(sprite_overlay_strong_badia_top, strong_badia_top_240p_bmp, strong_badia_top_240p_bmp_len, 0, 0, 1, 1, 1);
	sprite_overlay_strong_badia_top_ins = SpriteInstance(&sprite_overlay_strong_badia_top, 0, 0);
	PREPARE_SPRITE(sprite_overlay_strong_badia_bottom, strong_badia_bottom_240p_bmp, strong_badia_bottom_240p_bmp_len, 0, 210, 1, 1, 1);
	sprite_overlay_strong_badia_bottom_ins = SpriteInstance(&sprite_overlay_strong_badia_bottom, 0, 0);
	PREPARE_SPRITE(sprite_overlay_strong_badia_left, strong_badia_left_240p_bmp, strong_badia_left_240p_bmp_len, 0, 30, 1, 1, 1);
	sprite_overlay_strong_badia_left_ins = SpriteInstance(&sprite_overlay_strong_badia_left, 0, 0);
	PREPARE_SPRITE(sprite_overlay_strong_badia_right, strong_badia_right_240p_bmp, strong_badia_right_240p_bmp_len, 285, 30, 1, 1, 1);
