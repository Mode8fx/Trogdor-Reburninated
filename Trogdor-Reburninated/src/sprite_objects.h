...
extern void prepareSprite(SpriteObject*, unsigned char[], unsigned int, Sint8, Sint8, double, bool);
...
#define PREPARE_SPRITE(spriteObj, sprite_data, sprite_len, rect_x, rect_y, numFrames, numForms, scale) \
    prepareSprite(&spriteObj, sprite_data, sprite_len, numFrames, numForms, scale, false);             \
...
#define PREPARE_SPRITE_MENU(spriteObj, sprite_data, sprite_len, rect_x, rect_y, numFrames, numForms, scale) \
    prepareSprite(&spriteObj, sprite_data, sprite_len, numFrames, numForms, scale, true);                   \
    setSpritePos(&spriteObj, (int)rect_x, (int)rect_y);

#define PREPARE_SPRITE_BG(spriteObj, sprite_data, sprite_len, rect_x, rect_y) \
    PREPARE_SPRITE(spriteObj, sprite_data, sprite_len, rect_x, rect_y, 1, 1, 1);
