...
This will initially be available for PC, Switch, Wii U, Wii, Gamecube, Vita, and PSP. Android and LibRetro ports will likely be released at a later date. After v2.0, I will look into porting to other systems, but no promises.
...
- *v1.0*: Probably available once this repo goes public, but in case it's not, let's say... October 2022?
- *v1.5*: Sometime before January 13, 2023 (Trogdor's 20th birthday)
- *v2.0*: It'll be done when it's done, but I'd like to have it finished by March 17, 2023 (the 20th anniversary of the Flash game). But I'm only working on this as a hobby, so we'll see.
...
Sure, but not on all those consoles! <sub>(except Wii)</sub> And the ultimate goal is the release of v2.0, which aims to be the definitive way to play the game, even on PC.
